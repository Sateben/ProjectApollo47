    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result = new DrawerBuilder().withActivity(this)
                ...
                .addDrawerItems(new PrimaryDrawerItem()
                        ...
                        new SecondaryDrawerItem().withName("Check").withIcon(getResources().getDrawable(android.R.drawable.btn_radio))
                                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                                    @Override
                                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        new SecondaryDrawerItem()
                                .withName("Review")
                                .withIcon(getResources().getDrawable(android.R.drawable.ic_menu_call)))
