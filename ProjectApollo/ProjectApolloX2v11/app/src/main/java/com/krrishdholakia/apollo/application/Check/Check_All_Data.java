...
public class Check_All_Data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acitvity_check_up_all);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_check_all_data, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()) {
            ...
            case R.id.done_bar_data_input_all:
            {
                ...
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        BigDecimal NO_HD_BIN_simple_prob = BigDecimal.valueOf(CA_HD_prob * CPT_NO_prob * EIA_NO_prob * FBS_NO_prob * R_EKG_NO_prob * Slope_NO_prob * Sex_NO_prob * Thal_NO_prob * CA_NO_HD_prob);
                        ...
                        resting_bp_level_std_deviation_biased_NO = (Double.parseDouble(dataSnapshot.child("NO_HD_ND").child("Rest_BP_Level_NO_HD_ND").child("sum_of_Var_squared").getValue().toString()) / Double.parseDouble(dataSnapshot.child("NO_HD_ND").child("Rest_BP_Level_NO_HD_ND").child("number_of_Var").getValue().toString())) - Math.pow(resting_bp_level_mean, 2);
                        ...
                        if(User_Oldpeak == 0)
                        {
                            Log.i(TAG,"PROB_OF_NO: "+ Normal(age_std_deviation_unbiased_NO, User_Age, age_NO_mean) * (Normal(resting_bp_level_std_deviation_unbiased_NO, User_Resting_BP, resting_bp_level_mean_NO)));
                        ...
                        Intent intent = new Intent(Check_All_Data.this,Data_Check_Conclusion.class);
            ...
            case R.id.info_bar_data_input_all:
            {
                Log.i(TAG,"TEST");
